    ...
    <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 sm:mb-10 md:mb-12 text-center">
          <h2 className="text-2xl md:text-4xl  font-extrabold text-zinc-900 mb-3 sm:mb-4">
            Tools & Technology
          </h2>
           {/* <AnimatedHeading
                    level={2}
                    variant="glow"
                    className="font-inter text-black rounded-2xl p-3 font-extrabold"
                  >
                    Tools & Technologies
                  </AnimatedHeading> */}
          <p className="text-zinc-700 text-lg sm:text-base md:text-xl px-2">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-3 sm:gap-4 md:h-[600px]"
        >
          {/* Main Infrastructure Card */}
          <motion.div
            variants={itemVariants}
            className="md:col-span-1 md:row-span-2 relative group overflow-hidden bg-zinc-900 rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 flex flex-col justify-between min-h-[340px] sm:min-h-[380px] md:min-h-[320px]"
          >
          ...
          >
            ...
            <div className="w-24 h-24 sm:w-32 sm:h-32 bg-white rounded-2xl sm:rounded-3xl shadow-inner flex items-center justify-center border border-zinc-200">
              <ShieldCheck className="w-10 h-10 sm:w-12 sm:h-12 text-zinc-300" />
            </div>
          </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            className="md:col-span-1 md:row-span-2 bg-bsecondary rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 flex flex-col justify-between group min-h-[280px] sm:min-h-[320px]"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="md:col-span-2 md:row-span- relative overflow-hidden bg-zinc-50 rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 flex flex-col justify-between border border-zinc-200 min-h-[240px] sm:min-h-[280px]"
          >
            {/* Background Image */}

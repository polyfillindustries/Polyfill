...
export const Footer = () => {
  return (
    <footer className="bg-bgray text-white mt-auto">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-inter font-semibold text-lg mb-4 text-baccent">Company</h3>
          ...
          <div>
            <h3 className="font-inter font-semibold text-lg mb-4 text-baccent">Quick Links</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="font-inter font-semibold text-lg mb-4 text-baccent">Contact</h3>
            <ul className="space-y-3">
              <li>
                <a 
              ...
              <li>
                ...
                >
                  ...
                  <span className="font-inter text-sm">{CONTACT_INFO.address}</span>
                </a>
              </li>
            </ul>
              ...
              <div className="flex gap-4">
                {SOCIAL_LINKS.map((social) => (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-300 hover:text-baccent transition-colors"
